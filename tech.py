#!/usr/bin/python2
#coding=utf-8
#The Credit For This Code Goes To Sultantech
...
________________$$___$__$$
_______________$$______$$      Meer Sultan
...
\033[1;95m:•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬ •◈•\033[1;91mSultantech\033[1;95m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•
\033[1;91m:•◈•
\033[1;91m:•◈•╭━━━╮╱╱╭╮╭╮
\033[1;91m:•◈•┃╭━╮┃╱╱┃┣╯╰╮
\033[1;91m:•◈•┃╰━━┳╮╭┫┣╮╭╋━━┳━╮
...
\033[1;95m██║░╚═╝░██║███████╗███████╗██║░░██║
\033[1;95m╚═╝░░░░░╚═╝╚══════╝╚══════╝╚═╝░░╚═╝
\033[1;91m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•\033[1;95mSultantech\033[1;91m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•"""
...
jalan("\033[1;96m___§$$$$$#______MeerSultan_______$$$$$$$")
...
print "\033[1;95m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•\033[1;91mSultantech\033[1;95m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•"
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:Sultan_tech
	    time.sleep(2)
            loop = 'false'
        else:
            print "\033[1;91mWrong Password"
            os.system('xdg-open https://m.youtube.com/channel/UCVCWk2j_NmerbPnuCOmSXMg')
    else:
...
def login():
	...
	try:
		...
		jalan(' \033[1;93mChance,: \033[1;95mShadeed Single Munda' )
...
def menu():
	...
	try:
		...
		keluar()
	os.system("clear") #Dev:Sultan_tech
	print logo
...
•\033[1;95m◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•.
: \033[1;91m ....Sultantech  BlackMafia....... \033[1;95m :
•\033[1;95m◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•.' 
                WhatsApp Num
              \033[1;91m +923113628442"""
